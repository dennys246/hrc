...
def estimate_hrf():
    ...
    montage.save("P-CAT_hrfs.json")

    montage.load("P-CAT_hrfs.json")


def deconvolve_pcat(_overwrite = False):
    ...
    for subject_id, raw_nirx, preproc_nirx, nirx_events in zip(subject_ids, raw_scans, preproc_scans, scan_events):
        ...
        deconvolved_nirx = hrc.deconvolve_nirs(deconvolved_nirx, "P-CAT_hrfs.json")
        ...
        deconvolved_nirx.save(deconvolved_filename, overwrite = True)
